...
export default function Navigation() {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-4 left-3 right-3 z-[9999] w-auto max-w-[560px] rounded-full border border-white/[0.12] bg-[#090a0d]/80 px-1.5 py-1.5 shadow-[0_20px_70px_rgba(0,0,0,0.55)] backdrop-blur-2xl sm:bottom-6 sm:left-1/2 sm:right-auto sm:w-auto sm:-translate-x-1/2 sm:px-2 sm:py-2"
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className="relative flex flex-1 items-center justify-center rounded-full px-2 py-2.5 font-mono text-[8px] tracking-[0.10em] whitespace-nowrap transition-colors duration-300 xs:text-[9px] sm:flex-none sm:px-4 sm:py-2 sm:text-[10px] sm:tracking-[0.14em]"
              style={{
                color: isActive
            ...
            >
              {isActive && (
                <motion.span
                  layoutId="nav-active"
                  className="absolute inset-0 rounded-full border border-white/[0.10] bg-white/[0.055] shadow-[inset_0_1px_0_rgba(255,255,255,0.07)]"
